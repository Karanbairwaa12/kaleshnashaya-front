  ...
  return (
    <div className="bg-gray-100 h-full flex items-center justify-center p-8">
      <div className="bg-white/80 backdrop-blur-xl p-8 rounded-2xl shadow-xl max-w-3xl w-full border border-gray-300">
        <h2 className="text-3xl font-semibold text-gray-800 mb-6">Update Profile</h2>
        <form onSubmit={formik.handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label htmlFor="email_two_step_password" className="block text-sm font-medium text-gray-700 mb-2">
                Google 2-Factor Verification Password
              </label>
              <input
                type="password"
