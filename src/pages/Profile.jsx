...
import { Github, Linkedin, Instagram, Mail, Phone, Edit2, LogOut, ChevronLeft } from 'lucide-react';
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <a href={user?.github} className="text-blue-500 hover:text-blue-600 transition-colors">
                            GitHub Profile
                          </a>
                        </div>
                        <div className="flex items-center space-x-3">
                          <Linkedin className="w-5 h-5 text-gray-400" />
                          <a href={user?.linkedin} className="text-blue-500 hover:text-blue-600 transition-colors">
                            LinkedIn Profile
                          </a>
                        </div>
                        <div className="flex items-center space-x-3">
                          <Instagram className="w-5 h-5 text-gray-400" />
                          <a href={user?.instagram} className="text-blue-500 hover:text-blue-600 transition-colors">
                            Instagram Profile
                          </a>
                        </div>
                      </div>
